...
export default function WebsiteStatus() {
  ...
  return (
    <main className="flex flex-1 flex-col px-3 pb-8 pt-24 sm:px-6 md:px-8 lg:px-10">
            ...
            {loading ? (
              ...
              <div className="space-y-8">
                <div className="flex flex-col items-center gap-3 pt-1">
                  <h1 className="text-center text-3xl tracking-tight sm:text-4xl">Services Status</h1>
